...
async function run() {
  ...
  assert.deepEqual(Object.keys(t.controller).sort(), ['cancelOtp', 'getState', 'handleInitialIssue', 'requestOtp', 'resendOtp', 'setMode', 'startGoogleOAuth', 'verifyOtp'].sort());
  ...
  console.log('Auth controller tests passed: isolated API, modes, OTP, Google OAuth, errors, pending guards, cancel, and snapshots');
}
